...
<article>
	...
	<div class="awr"><?php endif; ?>
		...
		<?php if ( $ttAd = _thrive_get_ad_for_position( array(
			...
			<?php $ad_size = explode('x', $ttAd['size']); ?>
			<div style="width: <?php echo $ad_size[0]; ?>px; height: <?php echo $ad_size[1]; ?>px;" class="<?php echo _thrive_get_in_content_ad_container_class( $ttAd['parent'] ); ?>">
