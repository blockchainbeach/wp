...
class MyTheme_Customize {
	...
	public static function header_output() {
		...
		<style type="text/css">.wp-video-shortcode {
			...
			/* Featured block on homepage - font family */
			self::generate_css( '.bp-c h2', 'font-family', 'thrivetheme_header_font', '' );
			...
			self::generate_css( '.bSe h5', 'font-weight', 'thrivetheme_headline_weight', '' );
			/* Featured block on homepage - font family */
			self::generate_css( '.bp-c h2', 'font-weight', 'thrivetheme_headline_weight', '' );
