<div class="mets <?php echo $params['block_position_class']; ?> tt-share" data-url="<?php echo $params['url']; ?>"
	...
	<div class="bps">
				...
				<a class="fb" href="//www.facebook.com/sharer/sharer.php?u=<?php echo $params['url']; ?>"
				   onclick="return ThriveApp.open_share_popup(this.href, 545, 433);">
					...
					<?php if ( $params['options']['social_attention_grabber'] == "count" ): ?>
						<span class="ct">
                            <?php echo isset( $params['share_count']->facebook ) ? thrive_get_facebook_share( get_permalink( get_the_ID() ) ) : 0; ?>
                        </span>
					<?php endif; ?>
				</a>
			</div>
		...
		<?php if ( $params['options']['enable_twitter_button'] == 1 ): ?>
			<div class="ss">
				<a class="twitter"
				   href="https://twitter.com/share?text=<?php echo wp_strip_all_tags( get_the_title() ); ?>:&url=<?php echo $params['url']; ?>"
				   onclick="return ThriveApp.open_share_popup(this.href, 545, 433);">
