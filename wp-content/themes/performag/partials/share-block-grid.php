...
<div class="ixs">
	<div class="ixt" data-id="<?php echo $post_id; ?>">
		<?php if ( '0' === $params['share_count']->total ): ?>
			<?php echo $params['share_count']->total; ?> <?php echo _e( "Shares", 'thrive' ); ?></div>
		<?php else: ?>
				<?php echo _e( "Share", 'thrive' ); ?></div>
		<?php endif; ?>
<ul class="ixb"><!-- max 3-->
